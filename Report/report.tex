...
\pdiff{S_\text{w}}{t} + \div\left(\vec{F}(S, \vec{v}_\text{tot})\right) &= \frac{q_\text{w}}{\phi} \\
\vec{F}(S, \vec{v}_\text{tot}) &:= \frac{1}{\phi} \frac{S_\text{w}^2}{S_\text{w}^2 + (1-S_\text{w})^2 \mu_\text{w} / \mu_\text{o}} \vec{v}_\text{tot},
\end{empheq}
