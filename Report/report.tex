...
Numerical experiments and a discussion follow in section \ref{experiments}. Quantities needed for the implementation of the Monte-Carlo adjoint algorithm are given in the appendix in subsection \ref{quantitiesNeeded}.
...
\subsection{Computing the quantities for the Monte-Carlo adjoint solver}
